...
# --------------------------------------------------------------------
model_final = joblib.load('xgboost_model.pkl')
...
def predict_price():
    try:
        ...
        room_type_id = room_type_mapping[room_type_var.get()]
        amenities_dict = {
        ...
        # Prediction
        predicted_price = model_final.predict(input_features)
        messagebox.showinfo("Predicted Price", f"Predicted Price: {predicted_price[0]:.2f} € pro Nacht")
